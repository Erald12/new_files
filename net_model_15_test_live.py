                ...
                if side[0]==1 and actions[-2]==-1:
                    if entry_prices[0]<current_price:
                        for position in positions_recent:
                            ...
                            tp_order_id_a = tp_order['data'][0]['algoId']
                            tp_order_id = [tp_order_id_a]
                            ...
                            while True:
                                try:
                                    ...
                                    if len(positions_recent) == 0:
                                        ...
                                        try:
                                            algo_orders2 = [
                                                {"instId": symbol_2, "algoId": tp_order_id[0]}
                                            ]
                                    ...
                                    if len(positions_recent) > 0:
                                        ...
                                        for position in positions_recent:
                                            ...
                                            tp_order_id_new = tp_order['data'][0]['algoId']
                                            tp_order_id.append(tp_order_id_new)
                                            print('Close Position with Positive PNL is replaced.')
                                            time.sleep(3)
                                except Exception as e:
                                    print(e)
                        ...
                        for position in positions_recent:
                            ...
                            sl_order_id_a = sl_order['data'][0]['algoId']
                            sl_order_id = [sl_order_id_a]
                            ...
                            while True:
                                try:
                                    ...
                                    if len(positions_recent) == 0:
                                        ...
                                        try:
                                            algo_orders2 = [
                                                {"instId": symbol_2, "algoId": sl_order_id[0]}
                                            ]
                                    ...
                                    if len(positions_recent) > 0:
                                        ...
                                        for position in positions_recent:
                                            ...
                                            sl_order_id_new = sl_order['data'][0]['algoId']
                                            sl_order_id.append(sl_order_id_new)
                                            print('Close Position with Negative PNL is placed.')
                                            time.sleep(3)
                                except Exception as e:
                                    print(e)
