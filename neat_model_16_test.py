            ...
            def evaluate_genomes(genomes, config):
                ...
                for genome_id, genome in genomes:
                    ...
                    while True:
                        ...
                        state = np.concatenate([[signal()], [signal_symbolused_price(env, 0)], [signal_symbolused_price(env, 1)], [signal_symbolused_price(env, 2)], [signal_symbolused_price(env, 3)], [signal_symbolused_price(env, 4)], [signal_symbolused_price(env, 5)], [signal_symbolused_price(env, 6)], [signal_symbolused_price(env, 7)], [signal_symbolused_price(env, 8)], [signal_symbolused_price(env, 9)], [signal_symbolused_price(env, 10)], [signal_symbolused_price(env, 11)], [signal_symbolused_price(env, 12)], [signal_symbolused_price(env, 13)], [signal_symbolused_price(env, 14)]])
            ...
            while True:
                ...
                state2 = np.concatenate(
                    [[signal2()], [signal_symbolused_price(env2, 0)], [signal_symbolused_price(env2, 1)],
                     ...
                     [signal_symbolused_price(env2, 14)]])
