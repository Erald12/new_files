...
while True:
    try:
            ...
            def evaluate_genomes(genomes, config):
                ...
                for genome_id, genome in genomes:
                    ...
                    while True:
                        ...
                        state = np.concatenate([[signal()], [signal_symbolused_price(env, 0)], [signal_symbolused_price(env, 1)], [signal_symbolused_price(env, 2)], [signal_symbolused_price(env, 3)], [signal_symbolused_price(env, 4)], [signal_symbolused_price(env, 5)], [signal_symbolused_price(env, 6)], [signal_symbolused_price(env, 7)], [signal_symbolused_price(env, 8)], [signal_symbolused_price(env, 9)], [signal_symbolused_price(env, 10)], [signal_symbolused_price(env, 11)], [signal_symbolused_price(env, 12)], [signal_symbolused_price(env, 13)], [signal_symbolused_price(env, 14)], [signal_btc_price(env, 0)], [signal_btc_price(env, 1)], [signal_btc_price(env, 2)], [signal_btc_price(env, 3)], [signal_btc_price(env, 4)], [signal_btc_price(env, 5)], [signal_btc_price(env, 6)], [signal_btc_price(env, 7)], [signal_btc_price(env, 8)], [signal_btc_price(env, 9)], [signal_btc_price(env, 10)], [signal_btc_price(env, 11)], [signal_btc_price(env, 12)], [signal_btc_price(env, 13)], [signal_btc_price(env, 14)], [signal_sol_dom(env, 0)], [signal_sol_dom(env, 1)], [signal_sol_dom(env, 2)], [signal_sol_dom(env, 3)], [signal_sol_dom(env, 4)], [signal_sol_dom(env, 5)], [signal_sol_dom(env, 6)], [signal_sol_dom(env, 7)], [signal_sol_dom(env, 8)], [signal_sol_dom(env, 9)], [signal_sol_dom(env, 10)], [signal_sol_dom(env, 11)], [signal_sol_dom(env, 12)], [signal_sol_dom(env, 13)], [signal_sol_dom(env, 14)]])
        ...
        def test_model(net, test_data, config_path):
            ...
            PNL = (total_profits2-20)*100/20  # Calculate profit (final balance - initial balance)
            return round(PNL,2)
