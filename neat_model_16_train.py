...
while True:
    ...
    signal_btc('btc_sig_0', 0, 0)
    signal_btc('btc_sig_1', 1, 1)
    signal_btc('btc_sig_2', 2, 2)
    signal_btc('btc_sig_3', 3, 3)
    signal_btc('btc_sig_4', 4, 4)
    signal_btc('btc_sig_5', 5, 5)
    signal_btc('btc_sig_6', 6, 6)
    signal_btc('btc_sig_7', 7, 7)
    signal_btc('btc_sig_8', 8, 8)
    signal_btc('btc_sig_9', 9, 9)
    signal_btc('btc_sig_10', 10, 10)
    signal_btc('btc_sig_11', 11, 11)
    signal_btc('btc_sig_12', 12, 12)
    signal_btc('btc_sig_13', 13, 13)
    signal_btc('btc_sig_14', 14, 14)

    signal_sol('sol_dom_sig_0', 0, 0)
    signal_sol('sol_dom_sig_1', 1, 1)
    signal_sol('sol_dom_sig_2', 2, 2)
    signal_sol('sol_dom_sig_3', 3, 3)
    signal_sol('sol_dom_sig_4', 4, 4)
    signal_sol('sol_dom_sig_5', 5, 5)
    signal_sol('sol_dom_sig_6', 6, 6)
    signal_sol('sol_dom_sig_7', 7, 7)
    signal_sol('sol_dom_sig_8', 8, 8)
    signal_sol('sol_dom_sig_9', 9, 9)
    signal_sol('sol_dom_sig_10', 10, 10)
    signal_sol('sol_dom_sig_11', 11, 11)
    signal_sol('sol_dom_sig_12', 12, 12)
    signal_sol('sol_dom_sig_13', 13, 13)
    signal_sol('sol_dom_sig_14', 14, 14)
    ...
    data_inputs = pd.DataFrame({
        ...
        'btc_sig_0': data['btc_sig_0'],
        'btc_sig_1': data['btc_sig_1'],
        'btc_sig_2': data['btc_sig_2'],
        'btc_sig_3': data['btc_sig_3'],
        'btc_sig_4': data['btc_sig_4'],
        'btc_sig_5': data['btc_sig_5'],
        'btc_sig_6': data['btc_sig_6'],
        'btc_sig_7': data['btc_sig_7'],
        'btc_sig_8': data['btc_sig_8'],
        'btc_sig_9': data['btc_sig_9'],
        'btc_sig_10': data['btc_sig_10'],
        'btc_sig_11': data['btc_sig_11'],
        'btc_sig_12': data['btc_sig_12'],
        'btc_sig_13': data['btc_sig_13'],
        'btc_sig_14': data['btc_sig_14'],
        'sol_dom_sig_0': data['sol_dom_sig_0'],
        'sol_dom_sig_1': data['sol_dom_sig_1'],
        'sol_dom_sig_2': data['sol_dom_sig_2'],
        'sol_dom_sig_3': data['sol_dom_sig_3'],
        'sol_dom_sig_4': data['sol_dom_sig_4'],
        'sol_dom_sig_5': data['sol_dom_sig_5'],
        'sol_dom_sig_6': data['sol_dom_sig_6'],
        'sol_dom_sig_7': data['sol_dom_sig_7'],
        'sol_dom_sig_8': data['sol_dom_sig_8'],
        'sol_dom_sig_9': data['sol_dom_sig_9'],
        'sol_dom_sig_10': data['sol_dom_sig_10'],
        'sol_dom_sig_11': data['sol_dom_sig_11'],
        'sol_dom_sig_12': data['sol_dom_sig_12'],
        'sol_dom_sig_13': data['sol_dom_sig_13'],
        'sol_dom_sig_14': data['sol_dom_sig_14'],
        ...
        def evaluate_genomes(genomes, config):
            ...
            for genome_id, genome in genomes:
                ...
                while True:
                    ...
                    state = np.concatenate([[signal()], env.data.iloc[env.current_step, :45].values])
                ...
                while True:
                    ...
                    # Ensure state is compatible with neural network input size
                    state2 = np.concatenate([[signal2()], env2.data.iloc[env2.current_step, :45].values])
                    action2 = np.argmax(net.activate(state2)) - 1  # Map to -1, 0, 1

                    # Execute the action in the environment
                    balance2, done2, winloss2, total_profits2, action_list2 = env2.step(action2)
                    if done2:
                        break
    ...
    def create_neat_config():
        ...
        activation_options = softmax, tanh
